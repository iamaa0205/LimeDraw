  ...
  const steps = [
    {
      ...
      description: "Choose your lucky numbers and enter the lottery pool using cryptocurrency.",
      icon: "🎟️",
      color: "#00ff00",
    },
    {
      ...
      description: "Our blockchain-based system ensures all draws are verifiably fair and transparent.",
      icon: "🔍",
      color: "#00ffff",
    },
    {
      step: "Step 3",
      title: "Draw Winner",
      description: "Smart contracts randomly select the winner, with instant notification to all participants.",
      icon: "🏆",
      color: "#ff00ff",
    },
    {
      ...
      description: "Winners receive their crypto prizes directly in their wallet, no delays or intermediaries.",
      icon: "💰",
      color: "#ffff00",
    },
  ]
