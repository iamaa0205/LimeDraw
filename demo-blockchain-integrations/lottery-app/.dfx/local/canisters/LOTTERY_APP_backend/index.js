...
import { idlFactory } from './LOTTERY_APP_backend.did.js';
export { idlFactory } from './LOTTERY_APP_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LOTTERY_APP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./LOTTERY_APP_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the LOTTERY_APP_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./LOTTERY_APP_backend.did.js")._SERVICE>}
 */
export const LOTTERY_APP_backend = createActor(canisterId);
