...
import { idlFactory } from './mock_external.did.js';
export { idlFactory } from './mock_external.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MOCK_EXTERNAL;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mock_external.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mock_external canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mock_external.did.js")._SERVICE>}
 */
export const mock_external = createActor(canisterId);
