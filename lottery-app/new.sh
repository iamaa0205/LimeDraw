...
REQUIRED_COMMANDS="dfx cargo candid-extractor curl jq"
...
# Get the proxy contract id
PROXY_CONTRACT=$(get_proxy_contract "$CONTEXT_ID")
...
echo "Proxy Contract ID: ${PROXY_CONTRACT}"
